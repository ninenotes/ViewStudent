...
class Showscore1 extends StatefulWidget {
  const Showscore1({super.key});

  @override
  State<Showscore1> createState() => _Showscore1State();
  
}

class _Showscore1State extends State<Showscore1> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('64309010001'),
        ),
        body: FutureBuilder<DocumentSnapshot>(
          future: users.doc('dpiHsp9KLkYUM7bIxiD80hFkcdv1').get(),
          builder:
