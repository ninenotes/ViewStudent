...
class Showscore8 extends StatefulWidget {
  const Showscore8({super.key});

  @override
  State<Showscore8> createState() => _Showscore8State();
  
}

class _Showscore8State extends State<Showscore8> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('64309010008'),
        ),
        body: FutureBuilder<DocumentSnapshot>(
          future: users.doc('yHjj70VKemQK3fOWdlMgiiInNmu1').get(),
          builder:
