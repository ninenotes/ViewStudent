...
class Showscore4 extends StatefulWidget {
  const Showscore4({super.key});

  @override
  State<Showscore4> createState() => _Showscore4State();
  
}

class _Showscore4State extends State<Showscore4> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('64309010004'),
        ),
        body: FutureBuilder<DocumentSnapshot>(
          future: users.doc('07V3enfiSONGEV4LonHkwGGDbDm2').get(),
          builder:
