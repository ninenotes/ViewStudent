...
class Showscore6 extends StatefulWidget {
  const Showscore6({super.key});

  @override
  State<Showscore6> createState() => _Showscore6State();
  
}

class _Showscore6State extends State<Showscore6> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('64309010006'),
        ),
        body: FutureBuilder<DocumentSnapshot>(
          future: users.doc('Z63nYUk5YFP7Rh3X10XQF4rhStr2').get(),
          builder:
