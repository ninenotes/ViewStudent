...
class Showscore2 extends StatefulWidget {
  const Showscore2({super.key});

  @override
  State<Showscore2> createState() => _Showscore2State();
  
}

class _Showscore2State extends State<Showscore2> {
  @override
  Widget build(BuildContext context) {
    ...
    return Scaffold(
        appBar: AppBar(
          title: const Text('64309010002'),
        ),
        body: FutureBuilder<DocumentSnapshot>(
          future: users.doc('9ST1DfsT1XhUmJCqJwTnHZyfmdo2').get(),
          builder:
